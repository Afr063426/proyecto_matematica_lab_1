...
PensionMensualDetertinistico <-
  function(Edad, hombre, antiguedad, ultimo_salario, interes) {
    #Considerando una inflacion del 3%
    interes<-(interes-0.03)/(1+0.03)
    #anualidad
    ...
    #anualidad imnediata
      anualidad <-
        axn(ListaDeTablasHombres[[(Edad + 1)]], x = Edad,  i=interes,  k = 12, m=max(65-Edad,0), payment="immediate" )
        #llevar a futuro el salario
        ultimo_salario<-ultimo_salario*(1+0.05)^(max(65-Edad,0))
        antiguedad<-antiguedad+max(65-Edad,0)
    } else{
      anualidad <-
        axn(ListaDeTablasHombres[[(Edad + 1)]], x = Edad,  i=interes,  k = 12, m=max(62-Edad,0), payment="immediate"  )
        #llevar a futuro el salario
        ultimo_salario<-ultimo_salario*(1+0.05)^(max(62-Edad,0))
