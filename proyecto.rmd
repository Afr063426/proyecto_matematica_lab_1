...
Ejemplo<-sapply(tasas,TestPensionh)

TestRetiroh <- function(i){
 result <- mapply(
    SumaDeRetiroDetertinistico,
    afil_hombres$Antiguedad,
    T ,
...
PensionesH <- sapply(tasas,TestPensionh)

PensionesM <- sapply(tasas,TestPensionesM)

RetirosH <- sapply(tasas,TestRetiroh)

RetirosM <- sapply(tasas,TestRetiroM)


sensibilidad<- data.frame(tasas,PensionesH,PensionesM,RetirosH,RetirosM)

ggplot(sensibilidad)+geom_line(aes(tasas,RetirosH))+geom_line(aes(tasas,RetirosM))
